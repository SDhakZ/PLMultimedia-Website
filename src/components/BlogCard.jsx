...
export const BlogCard = (props) =>{
    ...
    return(
        <button className={BlogsCSS["blogCard"]} onClick={()=>{routeChange()}}>
            ...
            <div className={BlogsCSS["blogBodySection"]}>
              ...
              <p className={BlogsCSS["blogBody"]}>{props.body}</p>
            </div>

            <div className={BlogsCSS["authorSection"]}>
              <img className={BlogsCSS["authorImage"]} src={props.authorPP} alt="author"/>
